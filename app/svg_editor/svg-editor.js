		...
		var svgCanvas, urldata,
			...
			*/
			...
			defaultConfig = {
				...
				initTool: 'select',
				exportWindowType: 'download', // 'same' (todo: also support 'download')
				wireframe: false,
				showlayers: false,
				no_save_warning: true,
				// PATH CONFIGURATION
				// The following path configuration items are disallowed in the URL (as should any future path configurations)
				imgPath: 'svg_editor/images/',
				langPath: 'svg_editor/locale/',
				extPath: 'svg_editor/extensions/',
				jGraduatePath: 'svg_editor/jgraduate/images/',
				// DOCUMENT PROPERTIES
		...
		*/
		...
		editor.init = function () {
			...
			var supportsNonSS, resize_timer, changeZoom, Actions, curScrollPos,
				...
				ui_context = 'toolbars',
				origSource = editor.originalSource,
...
//						|| elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
			...
			var setFlyoutPositions = function() {
				$('.tools_flyout').each(function() {
					...
					$(this).css({left: (pos.left + w) * editor.tool_scale, top: pos.top-63});
				});
			};
