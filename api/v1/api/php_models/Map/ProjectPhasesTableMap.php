...
/**
 * This class defines the structure of the 'project_phases' table.
 *
 *
 *
 ...
 *
 */
class ProjectPhasesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ProjectPhasesTableMap';
     ...
     */
    const TABLE_NAME = 'project_phases';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\ProjectPhases';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ProjectPhases';
     ...
     */
    const COL_ID = 'project_phases.id';

    /**
     * the column name for the project_id field
     */
    const COL_PROJECT_ID = 'project_phases.project_id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'project_phases.name';

    /**
     * the column name for the date_time_created field
     */
    const COL_DATE_TIME_CREATED = 'project_phases.date_time_created';

    /**
     * the column name for the last_updated field
     */
    const COL_LAST_UPDATED = 'project_phases.last_updated';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ProjectId', 'Name', 'DateTimeCreated', 'LastUpdated', ),
        self::TYPE_CAMELNAME     => array('id', 'projectId', 'name', 'dateTimeCreated', 'lastUpdated', ),
        self::TYPE_COLNAME       => array(ProjectPhasesTableMap::COL_ID, ProjectPhasesTableMap::COL_PROJECT_ID, ProjectPhasesTableMap::COL_NAME, ProjectPhasesTableMap::COL_DATE_TIME_CREATED, ProjectPhasesTableMap::COL_LAST_UPDATED, ),
        self::TYPE_FIELDNAME     => array('id', 'project_id', 'name', 'date_time_created', 'last_updated', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ProjectId' => 1, 'Name' => 2, 'DateTimeCreated' => 3, 'LastUpdated' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'projectId' => 1, 'name' => 2, 'dateTimeCreated' => 3, 'lastUpdated' => 4, ),
        self::TYPE_COLNAME       => array(ProjectPhasesTableMap::COL_ID => 0, ProjectPhasesTableMap::COL_PROJECT_ID => 1, ProjectPhasesTableMap::COL_NAME => 2, ProjectPhasesTableMap::COL_DATE_TIME_CREATED => 3, ProjectPhasesTableMap::COL_LAST_UPDATED => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'project_id' => 1, 'name' => 2, 'date_time_created' => 3, 'last_updated' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        // attributes
        $this->setName('project_phases');
        $this->setPhpName('ProjectPhases');
        $this->setIdentifierQuoting(true);
        $this->setClassName('\\ProjectPhases');
        $this->setPackage('');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to project_phases     * by a foreign key with ON DELETE CASCADE
     */
    ...
    {
        return $withPrefix ? ProjectPhasesTableMap::CLASS_DEFAULT : ProjectPhasesTableMap::OM_CLASS;
    }
     ...
     * @return array           (ProjectPhases object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = ProjectPhasesTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = ProjectPhasesTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + ProjectPhasesTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ProjectPhasesTableMap::OM_CLASS;
            /** @var ProjectPhases $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            ProjectPhasesTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = ProjectPhasesTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = ProjectPhasesTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProjectPhasesTableMap::COL_ID);
            $criteria->addSelectColumn(ProjectPhasesTableMap::COL_PROJECT_ID);
            $criteria->addSelectColumn(ProjectPhasesTableMap::COL_NAME);
            $criteria->addSelectColumn(ProjectPhasesTableMap::COL_DATE_TIME_CREATED);
            $criteria->addSelectColumn(ProjectPhasesTableMap::COL_LAST_UPDATED);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(ProjectPhasesTableMap::DATABASE_NAME)->getTable(ProjectPhasesTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ProjectPhasesTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ProjectPhasesTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ProjectPhasesTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a ProjectPhases or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ProjectPhases object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ProjectPhases) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ProjectPhasesTableMap::DATABASE_NAME);
            $criteria->add(ProjectPhasesTableMap::COL_ID, (array) $values, Criteria::IN);
        }

        $query = ProjectPhasesQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            ProjectPhasesTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                ProjectPhasesTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return ProjectPhasesQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a ProjectPhases or Criteria object.
     *
     * @param mixed               $criteria Criteria or ProjectPhases object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from ProjectPhases object
        }

        if ($criteria->containsKey(ProjectPhasesTableMap::COL_ID) && $criteria->keyContainsValue(ProjectPhasesTableMap::COL_ID) ) {
...
} // ProjectPhasesTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
ProjectPhasesTableMap::buildTableMap();
