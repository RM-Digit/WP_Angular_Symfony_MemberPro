...
/**
 * Base class that represents a row from the 'improve_value_stream_diagram' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ImproveValueStreamDiagram implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ImproveValueStreamDiagramTableMap';
    ...
    /**
     * Initializes internal state of Base\ImproveValueStreamDiagram object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ImproveValueStreamDiagram</code> instance.  If
     * <code>obj</code> is an instance of <code>ImproveValueStreamDiagram</code>, delegates to
     * <code>equals(ImproveValueStreamDiagram)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ImproveValueStreamDiagram The current object, for fluid interface
     */
     ...
     * @return $this|\ImproveValueStreamDiagram The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setSvg($v)
    {
        ...
        if ($this->svg !== $v) {
            $this->svg = $v;
            $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_SVG] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('Svg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->svg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ImproveValueStreamDiagramTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = ImproveValueStreamDiagramTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ImproveValueStreamDiagram'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildImproveValueStreamDiagramQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ImproveValueStreamDiagram::setDeleted()
     * @see ImproveValueStreamDiagram::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildImproveValueStreamDiagramQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ImproveValueStreamDiagramTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ImproveValueStreamDiagramTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ImproveValueStreamDiagramTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_SVG)) {
            $modifiedColumns[':p' . $index++]  = '`svg`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `improve_value_stream_diagram` (%s) VALUES (%s)',
    ...
    {
        $pos = ImproveValueStreamDiagramTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ImproveValueStreamDiagram'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ImproveValueStreamDiagram'][$this->hashCode()] = true;
        $keys = ImproveValueStreamDiagramTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ImproveValueStreamDiagram
     */
    ...
    {
        $criteria = new Criteria(ImproveValueStreamDiagramTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_ID)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PROJECT_ID)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PHASE_ID)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_SVG)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_SVG, $this->svg);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(ImproveValueStreamDiagramTableMap::COL_LAST_UPDATED)) {
            $criteria->add(ImproveValueStreamDiagramTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildImproveValueStreamDiagramQuery::create();
        $criteria->add(ImproveValueStreamDiagramTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ImproveValueStreamDiagram (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ImproveValueStreamDiagram Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProjects(ChildProjects $v = null)
    {
        ...
        if ($v !== null) {
            $v->addImproveValueStreamDiagram($this);
        }
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addImproveValueStreamDiagrams($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addImproveValueStreamDiagrams($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addImproveValueStreamDiagrams($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeImproveValueStreamDiagram($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeImproveValueStreamDiagram($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeImproveValueStreamDiagram($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ImproveValueStreamDiagramTableMap::DEFAULT_STRING_FORMAT);
    }
