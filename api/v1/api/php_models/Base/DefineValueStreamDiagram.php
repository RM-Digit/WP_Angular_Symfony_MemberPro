...
/**
 * Base class that represents a row from the 'define_value_stream_diagram' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class DefineValueStreamDiagram implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DefineValueStreamDiagramTableMap';
    ...
    /**
     * Initializes internal state of Base\DefineValueStreamDiagram object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DefineValueStreamDiagram</code> instance.  If
     * <code>obj</code> is an instance of <code>DefineValueStreamDiagram</code>, delegates to
     * <code>equals(DefineValueStreamDiagram)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DefineValueStreamDiagram The current object, for fluid interface
     */
     ...
     * @return $this|\DefineValueStreamDiagram The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setSvg($v)
    {
        ...
        if ($this->svg !== $v) {
            $this->svg = $v;
            $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_SVG] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('Svg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->svg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DefineValueStreamDiagramTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = DefineValueStreamDiagramTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DefineValueStreamDiagram'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDefineValueStreamDiagramQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DefineValueStreamDiagram::setDeleted()
     * @see DefineValueStreamDiagram::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDefineValueStreamDiagramQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DefineValueStreamDiagramTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DefineValueStreamDiagramTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DefineValueStreamDiagramTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_SVG)) {
            $modifiedColumns[':p' . $index++]  = '`svg`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `define_value_stream_diagram` (%s) VALUES (%s)',
    ...
    {
        $pos = DefineValueStreamDiagramTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DefineValueStreamDiagram'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DefineValueStreamDiagram'][$this->hashCode()] = true;
        $keys = DefineValueStreamDiagramTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DefineValueStreamDiagram
     */
    ...
    {
        $criteria = new Criteria(DefineValueStreamDiagramTableMap::DATABASE_NAME);

        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_ID)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PROJECT_ID)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PHASE_ID)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_SVG)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_SVG, $this->svg);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(DefineValueStreamDiagramTableMap::COL_LAST_UPDATED)) {
            $criteria->add(DefineValueStreamDiagramTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildDefineValueStreamDiagramQuery::create();
        $criteria->add(DefineValueStreamDiagramTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DefineValueStreamDiagram (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DefineValueStreamDiagram Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProjects(ChildProjects $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDefineValueStreamDiagram($this);
        }
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addDefineValueStreamDiagrams($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addDefineValueStreamDiagrams($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addDefineValueStreamDiagrams($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeDefineValueStreamDiagram($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeDefineValueStreamDiagram($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeDefineValueStreamDiagram($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(DefineValueStreamDiagramTableMap::DEFAULT_STRING_FORMAT);
    }
