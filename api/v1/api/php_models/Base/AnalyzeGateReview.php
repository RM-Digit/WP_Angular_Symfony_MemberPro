...
/**
 * Base class that represents a row from the 'analyze_gate_review' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class AnalyzeGateReview implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AnalyzeGateReviewTableMap';
    ...
    /**
     * Initializes internal state of Base\AnalyzeGateReview object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AnalyzeGateReview</code> instance.  If
     * <code>obj</code> is an instance of <code>AnalyzeGateReview</code>, delegates to
     * <code>equals(AnalyzeGateReview)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AnalyzeGateReview The current object, for fluid interface
     */
     ...
     * @return $this|\AnalyzeGateReview The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setQuadrant($v)
    {
        ...
        if ($this->quadrant !== $v) {
            $this->quadrant = $v;
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_QUADRANT] = true;
        }
    ...
    public function setDetail($v)
    {
        ...
        if ($this->detail !== $v) {
            $this->detail = $v;
            $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_DETAIL] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('Quadrant', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quadrant = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('Detail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->detail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AnalyzeGateReviewTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = AnalyzeGateReviewTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AnalyzeGateReview'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAnalyzeGateReviewQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AnalyzeGateReview::setDeleted()
     * @see AnalyzeGateReview::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAnalyzeGateReviewQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AnalyzeGateReviewTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AnalyzeGateReviewTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AnalyzeGateReviewTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_QUADRANT)) {
            $modifiedColumns[':p' . $index++]  = '`quadrant`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_DETAIL)) {
            $modifiedColumns[':p' . $index++]  = '`detail`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `analyze_gate_review` (%s) VALUES (%s)',
    ...
    {
        $pos = AnalyzeGateReviewTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AnalyzeGateReview'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AnalyzeGateReview'][$this->hashCode()] = true;
        $keys = AnalyzeGateReviewTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(AnalyzeGateReviewTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_ID)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PROJECT_ID)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PHASE_ID)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_QUADRANT)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_QUADRANT, $this->quadrant);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_DETAIL)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_DETAIL, $this->detail);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(AnalyzeGateReviewTableMap::COL_LAST_UPDATED)) {
            $criteria->add(AnalyzeGateReviewTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildAnalyzeGateReviewQuery::create();
        $criteria->add(AnalyzeGateReviewTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AnalyzeGateReview (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AnalyzeGateReview Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addAnalyzeGateReviews($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addAnalyzeGateReviews($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addAnalyzeGateReviews($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeAnalyzeGateReview($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeAnalyzeGateReview($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeAnalyzeGateReview($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(AnalyzeGateReviewTableMap::DEFAULT_STRING_FORMAT);
    }
