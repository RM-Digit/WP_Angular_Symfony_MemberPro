...
/**
 * Base class that represents a row from the 'measure_nonvalue_analysis' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class MeasureNonvalueAnalysis implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MeasureNonvalueAnalysisTableMap';
    ...
    /**
     * The value for the improvements field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\MeasureNonvalueAnalysis object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MeasureNonvalueAnalysis</code> instance.  If
     * <code>obj</code> is an instance of <code>MeasureNonvalueAnalysis</code>, delegates to
     * <code>equals(MeasureNonvalueAnalysis)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MeasureNonvalueAnalysis The current object, for fluid interface
     */
    ...
    /**
     * Get the [improvements] column value.
     *
     * @return string
     */
     ...
     * @return $this|\MeasureNonvalueAnalysis The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setWaste($v)
    {
        ...
        if ($this->waste !== $v) {
            $this->waste = $v;
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_WASTE] = true;
        }
    ...
    /**
     * Set the value of [improvements] column.
     *
     * @param string $v new value
     * @return $this|\MeasureNonvalueAnalysis The current object (for fluent API support)
     */
    public function setImprovements($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->improvements !== $v) {
            $this->improvements = $v;
            $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_IMPROVEMENTS] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MeasureNonvalueAnalysisTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('Waste', TableMap::TYPE_PHPNAME, $indexType)];
            $this->waste = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('Improvements', TableMap::TYPE_PHPNAME, $indexType)];
            $this->improvements = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MeasureNonvalueAnalysisTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = MeasureNonvalueAnalysisTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MeasureNonvalueAnalysis'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMeasureNonvalueAnalysisQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MeasureNonvalueAnalysis::setDeleted()
     * @see MeasureNonvalueAnalysis::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMeasureNonvalueAnalysisQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MeasureNonvalueAnalysisTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_WASTE)) {
            $modifiedColumns[':p' . $index++]  = '`Waste`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_IMPROVEMENTS)) {
            $modifiedColumns[':p' . $index++]  = '`Improvements`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `measure_nonvalue_analysis` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`phase_component_id`':
                        ...
                        break;
                    case '`Waste`':
                        $stmt->bindValue($identifier, $this->waste, PDO::PARAM_STR);
                        break;
                    case '`Improvements`':
                        $stmt->bindValue($identifier, $this->improvements, PDO::PARAM_STR);
                        break;
    ...
    {
        $pos = MeasureNonvalueAnalysisTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MeasureNonvalueAnalysis'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MeasureNonvalueAnalysis'][$this->hashCode()] = true;
        $keys = MeasureNonvalueAnalysisTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProjectId(),
            $keys[2] => $this->getPhaseId(),
            $keys[3] => $this->getPhaseComponentId(),
            $keys[4] => $this->getWaste(),
            $keys[5] => $this->getImprovements(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MeasureNonvalueAnalysis
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setWaste($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setImprovements($arr[$keys[5]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_ID)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PROJECT_ID)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PHASE_ID)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_WASTE)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_WASTE, $this->waste);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_IMPROVEMENTS)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_IMPROVEMENTS, $this->improvements);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(MeasureNonvalueAnalysisTableMap::COL_LAST_UPDATED)) {
            $criteria->add(MeasureNonvalueAnalysisTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildMeasureNonvalueAnalysisQuery::create();
        $criteria->add(MeasureNonvalueAnalysisTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MeasureNonvalueAnalysis (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setWaste($this->getWaste());
        $copyObj->setImprovements($this->getImprovements());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MeasureNonvalueAnalysis Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProjects(ChildProjects $v = null)
    {
        ...
        if ($v !== null) {
            $v->addMeasureNonvalueAnalysis($this);
        }
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addMeasureNonvalueAnalyses($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addMeasureNonvalueAnalyses($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addMeasureNonvalueAnalyses($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeMeasureNonvalueAnalysis($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeMeasureNonvalueAnalysis($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeMeasureNonvalueAnalysis($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(MeasureNonvalueAnalysisTableMap::DEFAULT_STRING_FORMAT);
    }
