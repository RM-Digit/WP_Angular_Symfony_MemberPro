...
/**
 * Base class that represents a row from the 'define_voc_ccr' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class DefineVocCcr implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DefineVocCcrTableMap';
    ...
    /**
     * The value for the customer_issues field.
     *
     * @var        string
     */
    protected $customer_issues;

    /**
     * The value for the customer_requirements field.
     *
     * @var        string
     */
    protected $customer_requirements;
    ...
    /**
     * Initializes internal state of Base\DefineVocCcr object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DefineVocCcr</code> instance.  If
     * <code>obj</code> is an instance of <code>DefineVocCcr</code>, delegates to
     * <code>equals(DefineVocCcr)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DefineVocCcr The current object, for fluid interface
     */
    ...
    /**
     * Get the [customer_issues] column value.
     *
     * @return string
     */
    public function getCustomerIssues()
    {
        return $this->customer_issues;
    }

    /**
     * Get the [customer_requirements] column value.
     *
     * @return string
     */
    public function getCustomerRequirements()
    {
        return $this->customer_requirements;
    }
     ...
     * @return $this|\DefineVocCcr The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[DefineVocCcrTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setTool($v)
    {
        ...
        if ($this->tool !== $v) {
            $this->tool = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_TOOL] = true;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_QUANTITY] = true;
        }
    ...
    /**
     * Set the value of [customer_issues] column.
     *
     * @param string $v new value
     * @return $this|\DefineVocCcr The current object (for fluent API support)
     */
    public function setCustomerIssues($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->customer_issues !== $v) {
            $this->customer_issues = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_CUSTOMER_ISSUES] = true;
        }
    ...
    /**
     * Set the value of [customer_requirements] column.
     *
     * @param string $v new value
     * @return $this|\DefineVocCcr The current object (for fluent API support)
     */
    public function setCustomerRequirements($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->customer_requirements !== $v) {
            $this->customer_requirements = $v;
            $this->modifiedColumns[DefineVocCcrTableMap::COL_CUSTOMER_REQUIREMENTS] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineVocCcrTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineVocCcrTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DefineVocCcrTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DefineVocCcrTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DefineVocCcrTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DefineVocCcrTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DefineVocCcrTableMap::translateFieldName('Tool', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tool = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DefineVocCcrTableMap::translateFieldName('Quantity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DefineVocCcrTableMap::translateFieldName('CustomerIssues', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_issues = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : DefineVocCcrTableMap::translateFieldName('CustomerRequirements', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_requirements = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : DefineVocCcrTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : DefineVocCcrTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 10; // 10 = DefineVocCcrTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DefineVocCcr'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDefineVocCcrQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DefineVocCcr::setDeleted()
     * @see DefineVocCcr::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDefineVocCcrQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DefineVocCcrTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_TOOL)) {
            $modifiedColumns[':p' . $index++]  = '`tool`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_QUANTITY)) {
            $modifiedColumns[':p' . $index++]  = '`quantity`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_CUSTOMER_ISSUES)) {
            $modifiedColumns[':p' . $index++]  = '`customer_issues`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_CUSTOMER_REQUIREMENTS)) {
            $modifiedColumns[':p' . $index++]  = '`customer_requirements`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `define_voc_ccr` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`phase_id`':
                        ...
                        break;
                    case '`tool`':
                        $stmt->bindValue($identifier, $this->tool, PDO::PARAM_STR);
                        break;
                    case '`quantity`':
                        $stmt->bindValue($identifier, $this->quantity, PDO::PARAM_INT);
                        break;
                    case '`customer_issues`':
                        $stmt->bindValue($identifier, $this->customer_issues, PDO::PARAM_STR);
                        break;
                    case '`customer_requirements`':
                        $stmt->bindValue($identifier, $this->customer_requirements, PDO::PARAM_STR);
                        break;
    ...
    {
        $pos = DefineVocCcrTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                return $this->getCustomerIssues();
                break;
            case 7:
                return $this->getCustomerRequirements();
                break;
            case 8:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DefineVocCcr'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DefineVocCcr'][$this->hashCode()] = true;
        $keys = DefineVocCcrTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProjectId(),
            $keys[2] => $this->getPhaseComponentId(),
            $keys[3] => $this->getPhaseId(),
            $keys[4] => $this->getTool(),
            $keys[5] => $this->getQuantity(),
            $keys[6] => $this->getCustomerIssues(),
            $keys[7] => $this->getCustomerRequirements(),
            $keys[8] => $this->getDateTimeCreated(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setCustomerIssues($value);
                break;
            case 7:
                $this->setCustomerRequirements($value);
                break;
            case 8:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setPhaseComponentId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setPhaseId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setTool($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setQuantity($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setCustomerIssues($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setCustomerRequirements($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDateTimeCreated($arr[$keys[8]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_ID)) {
            $criteria->add(DefineVocCcrTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PROJECT_ID)) {
            $criteria->add(DefineVocCcrTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(DefineVocCcrTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_PHASE_ID)) {
            $criteria->add(DefineVocCcrTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_TOOL)) {
            $criteria->add(DefineVocCcrTableMap::COL_TOOL, $this->tool);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_QUANTITY)) {
            $criteria->add(DefineVocCcrTableMap::COL_QUANTITY, $this->quantity);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_CUSTOMER_ISSUES)) {
            $criteria->add(DefineVocCcrTableMap::COL_CUSTOMER_ISSUES, $this->customer_issues);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_CUSTOMER_REQUIREMENTS)) {
            $criteria->add(DefineVocCcrTableMap::COL_CUSTOMER_REQUIREMENTS, $this->customer_requirements);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(DefineVocCcrTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(DefineVocCcrTableMap::COL_LAST_UPDATED)) {
            $criteria->add(DefineVocCcrTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildDefineVocCcrQuery::create();
        $criteria->add(DefineVocCcrTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DefineVocCcr (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTool($this->getTool());
        $copyObj->setQuantity($this->getQuantity());
        $copyObj->setCustomerIssues($this->getCustomerIssues());
        $copyObj->setCustomerRequirements($this->getCustomerRequirements());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DefineVocCcr Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addDefineVocCcrs($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addDefineVocCcrs($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addDefineVocCcrs($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeDefineVocCcr($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeDefineVocCcr($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeDefineVocCcr($this);
        }
        $this->id = null;
        ...
        $this->tool = null;
        $this->quantity = null;
        $this->customer_issues = null;
        $this->customer_requirements = null;
    ...
    {
        return (string) $this->exportTo(DefineVocCcrTableMap::DEFAULT_STRING_FORMAT);
    }
