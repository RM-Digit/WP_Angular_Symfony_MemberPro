...
/**
 * Base class that represents a row from the 'define_raci' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class DefineRaci implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DefineRaciTableMap';
    ...
    /**
     * The value for the owners field.
     *
     * @var        string
     */
    protected $owners;
    ...
    /**
     * Initializes internal state of Base\DefineRaci object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DefineRaci</code> instance.  If
     * <code>obj</code> is an instance of <code>DefineRaci</code>, delegates to
     * <code>equals(DefineRaci)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DefineRaci The current object, for fluid interface
     */
     ...
     * @return $this|\DefineRaci The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[DefineRaciTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setActivity($v)
    {
        ...
        if ($this->activity !== $v) {
            $this->activity = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_ACTIVITY] = true;
        }
    ...
    /**
     * Set the value of [raci] column.
     *
     * @param string $v new value
     * @return $this|\DefineRaci The current object (for fluent API support)
     */
    public function setRaci($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->raci !== $v) {
            $this->raci = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_RACI] = true;
        }
    ...
    /**
     * Set the value of [owners] column.
     *
     * @param string $v new value
     * @return $this|\DefineRaci The current object (for fluent API support)
     */
    public function setOwners($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->owners !== $v) {
            $this->owners = $v;
            $this->modifiedColumns[DefineRaciTableMap::COL_OWNERS] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineRaciTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineRaciTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DefineRaciTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DefineRaciTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DefineRaciTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DefineRaciTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DefineRaciTableMap::translateFieldName('Activity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DefineRaciTableMap::translateFieldName('Raci', TableMap::TYPE_PHPNAME, $indexType)];
            $this->raci = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DefineRaciTableMap::translateFieldName('Owners', TableMap::TYPE_PHPNAME, $indexType)];
            $this->owners = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : DefineRaciTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : DefineRaciTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = DefineRaciTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DefineRaci'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDefineRaciQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DefineRaci::setDeleted()
     * @see DefineRaci::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDefineRaciQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DefineRaciTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DefineRaciTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_ACTIVITY)) {
            $modifiedColumns[':p' . $index++]  = '`activity`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_RACI)) {
            $modifiedColumns[':p' . $index++]  = '`raci`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_OWNERS)) {
            $modifiedColumns[':p' . $index++]  = '`owners`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `define_raci` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`activity`':
                        ...
                        break;
                    case '`raci`':
                        $stmt->bindValue($identifier, $this->raci, PDO::PARAM_STR);
                        break;
                    case '`owners`':
                        $stmt->bindValue($identifier, $this->owners, PDO::PARAM_STR);
                        break;
    ...
    {
        $pos = DefineRaciTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DefineRaci'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DefineRaci'][$this->hashCode()] = true;
        $keys = DefineRaciTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setActivity($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setRaci($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setOwners($arr[$keys[6]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DefineRaciTableMap::COL_ID)) {
            $criteria->add(DefineRaciTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PROJECT_ID)) {
            $criteria->add(DefineRaciTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PHASE_ID)) {
            $criteria->add(DefineRaciTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(DefineRaciTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_ACTIVITY)) {
            $criteria->add(DefineRaciTableMap::COL_ACTIVITY, $this->activity);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_RACI)) {
            $criteria->add(DefineRaciTableMap::COL_RACI, $this->raci);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_OWNERS)) {
            $criteria->add(DefineRaciTableMap::COL_OWNERS, $this->owners);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(DefineRaciTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(DefineRaciTableMap::COL_LAST_UPDATED)) {
            $criteria->add(DefineRaciTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildDefineRaciQuery::create();
        $criteria->add(DefineRaciTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DefineRaci (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRaci($this->getRaci());
        $copyObj->setOwners($this->getOwners());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DefineRaci Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addDefineRacis($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addDefineRacis($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addDefineRacis($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeDefineRaci($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeDefineRaci($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeDefineRaci($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(DefineRaciTableMap::DEFAULT_STRING_FORMAT);
    }
