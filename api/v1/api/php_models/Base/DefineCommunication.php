...
/**
 * Base class that represents a row from the 'define_communication' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class DefineCommunication implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DefineCommunicationTableMap';
    ...
    /**
     * The value for the day_time field.
     *
     * @var        string
     */
    protected $day_time;
    ...
    /**
     * Initializes internal state of Base\DefineCommunication object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DefineCommunication</code> instance.  If
     * <code>obj</code> is an instance of <code>DefineCommunication</code>, delegates to
     * <code>equals(DefineCommunication)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DefineCommunication The current object, for fluid interface
     */
     ...
     * @return $this|\DefineCommunication The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[DefineCommunicationTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setMedia($v)
    {
        ...
        if ($this->media !== $v) {
            $this->media = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_MEDIA] = true;
        }
    ...
    public function setPurpose($v)
    {
        ...
        if ($this->purpose !== $v) {
            $this->purpose = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_PURPOSE] = true;
        }
    ...
    public function setOwner($v)
    {
        ...
        if ($this->owner !== $v) {
            $this->owner = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_OWNER] = true;
        }
    ...
    public function setFrequency($v)
    {
        ...
        if ($this->frequency !== $v) {
            $this->frequency = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_FREQUENCY] = true;
        }
    ...
    /**
     * Set the value of [day_time] column.
     *
     * @param string $v new value
     * @return $this|\DefineCommunication The current object (for fluent API support)
     */
    public function setDayTime($v)
    {
        ...
        if ($this->day_time !== $v) {
            $this->day_time = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_DAY_TIME] = true;
        }
    ...
    public function setLength($v)
    {
        ...
        if ($this->length !== $v) {
            $this->length = $v;
            $this->modifiedColumns[DefineCommunicationTableMap::COL_LENGTH] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineCommunicationTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DefineCommunicationTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DefineCommunicationTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DefineCommunicationTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DefineCommunicationTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DefineCommunicationTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DefineCommunicationTableMap::translateFieldName('Media', TableMap::TYPE_PHPNAME, $indexType)];
            $this->media = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DefineCommunicationTableMap::translateFieldName('Purpose', TableMap::TYPE_PHPNAME, $indexType)];
            $this->purpose = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DefineCommunicationTableMap::translateFieldName('Owner', TableMap::TYPE_PHPNAME, $indexType)];
            $this->owner = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : DefineCommunicationTableMap::translateFieldName('Frequency', TableMap::TYPE_PHPNAME, $indexType)];
            $this->frequency = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : DefineCommunicationTableMap::translateFieldName('DayTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->day_time = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : DefineCommunicationTableMap::translateFieldName('Length', TableMap::TYPE_PHPNAME, $indexType)];
            $this->length = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : DefineCommunicationTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : DefineCommunicationTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 12; // 12 = DefineCommunicationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DefineCommunication'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aUsers !== null && $this->owner !== $this->aUsers->getId()) {
            $this->aUsers = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDefineCommunicationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DefineCommunication::setDeleted()
     * @see DefineCommunication::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDefineCommunicationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DefineCommunicationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_MEDIA)) {
            $modifiedColumns[':p' . $index++]  = '`media`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PURPOSE)) {
            $modifiedColumns[':p' . $index++]  = '`purpose`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_OWNER)) {
            $modifiedColumns[':p' . $index++]  = '`owner`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_FREQUENCY)) {
            $modifiedColumns[':p' . $index++]  = '`frequency`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_DAY_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`day_time`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_LENGTH)) {
            $modifiedColumns[':p' . $index++]  = '`length`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `define_communication` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`frequency`':
                        ...
                        break;
                    case '`day_time`':
                        $stmt->bindValue($identifier, $this->day_time, PDO::PARAM_STR);
                        break;
                    case '`length`':
    ...
    {
        $pos = DefineCommunicationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DefineCommunication'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DefineCommunication'][$this->hashCode()] = true;
        $keys = DefineCommunicationTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[6] => $this->getOwner(),
            $keys[7] => $this->getFrequency(),
            $keys[8] => $this->getDayTime(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\DefineCommunication
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setMedia($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPurpose($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setOwner($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setFrequency($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDayTime($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setLength($arr[$keys[9]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_ID)) {
            $criteria->add(DefineCommunicationTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PROJECT_ID)) {
            $criteria->add(DefineCommunicationTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PHASE_ID)) {
            $criteria->add(DefineCommunicationTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(DefineCommunicationTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_MEDIA)) {
            $criteria->add(DefineCommunicationTableMap::COL_MEDIA, $this->media);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_PURPOSE)) {
            $criteria->add(DefineCommunicationTableMap::COL_PURPOSE, $this->purpose);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_OWNER)) {
            $criteria->add(DefineCommunicationTableMap::COL_OWNER, $this->owner);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_FREQUENCY)) {
            $criteria->add(DefineCommunicationTableMap::COL_FREQUENCY, $this->frequency);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_DAY_TIME)) {
            $criteria->add(DefineCommunicationTableMap::COL_DAY_TIME, $this->day_time);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_LENGTH)) {
            $criteria->add(DefineCommunicationTableMap::COL_LENGTH, $this->length);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(DefineCommunicationTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(DefineCommunicationTableMap::COL_LAST_UPDATED)) {
            $criteria->add(DefineCommunicationTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildDefineCommunicationQuery::create();
        $criteria->add(DefineCommunicationTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DefineCommunication (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDayTime($this->getDayTime());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DefineCommunication Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addDefineCommunications($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addDefineCommunications($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addDefineCommunications($this);
             */
        }
    ...
    {
        if ($this->aUsers === null && ($this->owner != 0)) {
            $this->aUsers = ChildUsersQuery::create()->findPk($this->owner, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsers->addDefineCommunications($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeDefineCommunication($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeDefineCommunication($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeDefineCommunication($this);
        }
        if (null !== $this->aUsers) {
            $this->aUsers->removeDefineCommunication($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(DefineCommunicationTableMap::DEFAULT_STRING_FORMAT);
    }
