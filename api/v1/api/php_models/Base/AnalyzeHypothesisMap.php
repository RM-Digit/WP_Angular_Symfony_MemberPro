...
/**
 * Base class that represents a row from the 'analyze_hypothesis_map' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class AnalyzeHypothesisMap implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AnalyzeHypothesisMapTableMap';
    ...
    /**
     * Initializes internal state of Base\AnalyzeHypothesisMap object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AnalyzeHypothesisMap</code> instance.  If
     * <code>obj</code> is an instance of <code>AnalyzeHypothesisMap</code>, delegates to
     * <code>equals(AnalyzeHypothesisMap)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AnalyzeHypothesisMap The current object, for fluid interface
     */
     ...
     * @return $this|\AnalyzeHypothesisMap The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setSvg($v)
    {
        ...
        if ($this->svg !== $v) {
            $this->svg = $v;
            $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_SVG] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('Svg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->svg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AnalyzeHypothesisMapTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = AnalyzeHypothesisMapTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AnalyzeHypothesisMap'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAnalyzeHypothesisMapQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AnalyzeHypothesisMap::setDeleted()
     * @see AnalyzeHypothesisMap::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAnalyzeHypothesisMapQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AnalyzeHypothesisMapTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AnalyzeHypothesisMapTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AnalyzeHypothesisMapTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_SVG)) {
            $modifiedColumns[':p' . $index++]  = '`svg`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `analyze_hypothesis_map` (%s) VALUES (%s)',
    ...
    {
        $pos = AnalyzeHypothesisMapTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AnalyzeHypothesisMap'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AnalyzeHypothesisMap'][$this->hashCode()] = true;
        $keys = AnalyzeHypothesisMapTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AnalyzeHypothesisMap
     */
    ...
    {
        $criteria = new Criteria(AnalyzeHypothesisMapTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_ID)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PROJECT_ID)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PHASE_ID)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_SVG)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_SVG, $this->svg);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(AnalyzeHypothesisMapTableMap::COL_LAST_UPDATED)) {
            $criteria->add(AnalyzeHypothesisMapTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildAnalyzeHypothesisMapQuery::create();
        $criteria->add(AnalyzeHypothesisMapTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AnalyzeHypothesisMap (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AnalyzeHypothesisMap Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProjects(ChildProjects $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAnalyzeHypothesisMap($this);
        }
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addAnalyzeHypothesisMaps($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addAnalyzeHypothesisMaps($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addAnalyzeHypothesisMaps($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeAnalyzeHypothesisMap($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeAnalyzeHypothesisMap($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeAnalyzeHypothesisMap($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(AnalyzeHypothesisMapTableMap::DEFAULT_STRING_FORMAT);
    }
