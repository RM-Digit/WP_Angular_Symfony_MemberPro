...
/**
 * Base class that represents a row from the 'control_control_plan' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ControlControlPlan implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ControlControlPlanTableMap';
    ...
    /**
     * Initializes internal state of Base\ControlControlPlan object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ControlControlPlan</code> instance.  If
     * <code>obj</code> is an instance of <code>ControlControlPlan</code>, delegates to
     * <code>equals(ControlControlPlan)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ControlControlPlan The current object, for fluid interface
     */
     ...
     * @return $this|\ControlControlPlan The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setProcessSteps($v)
    {
        ...
        if ($this->process_steps !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_PROCESS_STEPS] = true;
        }
    ...
    public function setCtq($v)
    {
        ...
        if ($this->ctq !== $v) {
            $this->ctq = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_CTQ] = true;
        }
    ...
    public function setSpecificationCharacteristic($v)
    {
        ...
        if ($this->specification_characteristic !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_SPECIFICATION_CHARACTERISTIC] = true;
        }
    ...
    public function setLsl($v)
    {
        ...
        if ($this->lsl !== $v) {
            $this->lsl = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_LSL] = true;
        }
    ...
    public function setUsl($v)
    {
        ...
        if ($this->usl !== $v) {
            $this->usl = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_USL] = true;
        }
    ...
    public function setUnitOfMeasure($v)
    {
        ...
        if ($this->unit_of_measure !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_UNIT_OF_MEASURE] = true;
        }
    ...
    public function setDataDescription($v)
    {
        ...
        if ($this->data_description !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_DATA_DESCRIPTION] = true;
        }
    ...
    public function setMeasurementMethod($v)
    {
        ...
        if ($this->measurement_method !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_MEASUREMENT_METHOD] = true;
        }
    ...
    public function setSampleSize($v)
    {
        ...
        if ($this->sample_size !== $v) {
            $this->sample_size = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_SAMPLE_SIZE] = true;
        }
    ...
    public function setMeasurementFrequency($v)
    {
        ...
        if ($this->measurement_frequency !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_MEASUREMENT_FREQUENCY] = true;
        }
    ...
    public function setWhoMeasures($v)
    {
        ...
        if ($this->who_measures !== $v) {
            $this->who_measures = $v;
            $this->modifiedColumns[ControlControlPlanTableMap::COL_WHO_MEASURES] = true;
        }
    ...
    public function setWhereRecorded($v)
    {
        ...
        if ($this->where_recorded !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_WHERE_RECORDED] = true;
        }
    ...
    public function setCorrectiveAction($v)
    {
        ...
        if ($this->corrective_action !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_CORRECTIVE_ACTION] = true;
        }
    ...
    public function setApplicableSop($v)
    {
        ...
        if ($this->applicable_sop !== $v) {
            ...
            $this->modifiedColumns[ControlControlPlanTableMap::COL_APPLICABLE_SOP] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ControlControlPlanTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ControlControlPlanTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ControlControlPlanTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ControlControlPlanTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ControlControlPlanTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ControlControlPlanTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ControlControlPlanTableMap::translateFieldName('ProcessSteps', TableMap::TYPE_PHPNAME, $indexType)];
            $this->process_steps = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ControlControlPlanTableMap::translateFieldName('Ctq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ctq = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ControlControlPlanTableMap::translateFieldName('SpecificationCharacteristic', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specification_characteristic = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ControlControlPlanTableMap::translateFieldName('Lsl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lsl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ControlControlPlanTableMap::translateFieldName('Usl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ControlControlPlanTableMap::translateFieldName('UnitOfMeasure', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit_of_measure = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ControlControlPlanTableMap::translateFieldName('DataDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->data_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ControlControlPlanTableMap::translateFieldName('MeasurementMethod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->measurement_method = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ControlControlPlanTableMap::translateFieldName('SampleSize', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sample_size = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ControlControlPlanTableMap::translateFieldName('MeasurementFrequency', TableMap::TYPE_PHPNAME, $indexType)];
            $this->measurement_frequency = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ControlControlPlanTableMap::translateFieldName('WhoMeasures', TableMap::TYPE_PHPNAME, $indexType)];
            $this->who_measures = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ControlControlPlanTableMap::translateFieldName('WhereRecorded', TableMap::TYPE_PHPNAME, $indexType)];
            $this->where_recorded = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ControlControlPlanTableMap::translateFieldName('CorrectiveAction', TableMap::TYPE_PHPNAME, $indexType)];
            $this->corrective_action = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ControlControlPlanTableMap::translateFieldName('ApplicableSop', TableMap::TYPE_PHPNAME, $indexType)];
            $this->applicable_sop = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ControlControlPlanTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ControlControlPlanTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 20; // 20 = ControlControlPlanTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ControlControlPlan'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildControlControlPlanQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ControlControlPlan::setDeleted()
     * @see ControlControlPlan::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildControlControlPlanQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ControlControlPlanTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PROCESS_STEPS)) {
            $modifiedColumns[':p' . $index++]  = '`process_steps`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_CTQ)) {
            $modifiedColumns[':p' . $index++]  = '`ctq`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_SPECIFICATION_CHARACTERISTIC)) {
            $modifiedColumns[':p' . $index++]  = '`specification_characteristic`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_LSL)) {
            $modifiedColumns[':p' . $index++]  = '`lsl`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_USL)) {
            $modifiedColumns[':p' . $index++]  = '`usl`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_UNIT_OF_MEASURE)) {
            $modifiedColumns[':p' . $index++]  = '`unit_of_measure`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_DATA_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`data_description`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_MEASUREMENT_METHOD)) {
            $modifiedColumns[':p' . $index++]  = '`measurement_method`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_SAMPLE_SIZE)) {
            $modifiedColumns[':p' . $index++]  = '`sample_size`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_MEASUREMENT_FREQUENCY)) {
            $modifiedColumns[':p' . $index++]  = '`measurement_frequency`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_WHO_MEASURES)) {
            $modifiedColumns[':p' . $index++]  = '`who_measures`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_WHERE_RECORDED)) {
            $modifiedColumns[':p' . $index++]  = '`where_recorded`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_CORRECTIVE_ACTION)) {
            $modifiedColumns[':p' . $index++]  = '`corrective_action`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_APPLICABLE_SOP)) {
            $modifiedColumns[':p' . $index++]  = '`applicable_sop`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `control_control_plan` (%s) VALUES (%s)',
    ...
    {
        $pos = ControlControlPlanTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ControlControlPlan'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ControlControlPlan'][$this->hashCode()] = true;
        $keys = ControlControlPlanTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ControlControlPlan
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_ID)) {
            $criteria->add(ControlControlPlanTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PROJECT_ID)) {
            $criteria->add(ControlControlPlanTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PHASE_ID)) {
            $criteria->add(ControlControlPlanTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(ControlControlPlanTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_PROCESS_STEPS)) {
            $criteria->add(ControlControlPlanTableMap::COL_PROCESS_STEPS, $this->process_steps);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_CTQ)) {
            $criteria->add(ControlControlPlanTableMap::COL_CTQ, $this->ctq);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_SPECIFICATION_CHARACTERISTIC)) {
            $criteria->add(ControlControlPlanTableMap::COL_SPECIFICATION_CHARACTERISTIC, $this->specification_characteristic);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_LSL)) {
            $criteria->add(ControlControlPlanTableMap::COL_LSL, $this->lsl);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_USL)) {
            $criteria->add(ControlControlPlanTableMap::COL_USL, $this->usl);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_UNIT_OF_MEASURE)) {
            $criteria->add(ControlControlPlanTableMap::COL_UNIT_OF_MEASURE, $this->unit_of_measure);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_DATA_DESCRIPTION)) {
            $criteria->add(ControlControlPlanTableMap::COL_DATA_DESCRIPTION, $this->data_description);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_MEASUREMENT_METHOD)) {
            $criteria->add(ControlControlPlanTableMap::COL_MEASUREMENT_METHOD, $this->measurement_method);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_SAMPLE_SIZE)) {
            $criteria->add(ControlControlPlanTableMap::COL_SAMPLE_SIZE, $this->sample_size);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_MEASUREMENT_FREQUENCY)) {
            $criteria->add(ControlControlPlanTableMap::COL_MEASUREMENT_FREQUENCY, $this->measurement_frequency);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_WHO_MEASURES)) {
            $criteria->add(ControlControlPlanTableMap::COL_WHO_MEASURES, $this->who_measures);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_WHERE_RECORDED)) {
            $criteria->add(ControlControlPlanTableMap::COL_WHERE_RECORDED, $this->where_recorded);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_CORRECTIVE_ACTION)) {
            $criteria->add(ControlControlPlanTableMap::COL_CORRECTIVE_ACTION, $this->corrective_action);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_APPLICABLE_SOP)) {
            $criteria->add(ControlControlPlanTableMap::COL_APPLICABLE_SOP, $this->applicable_sop);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(ControlControlPlanTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(ControlControlPlanTableMap::COL_LAST_UPDATED)) {
            $criteria->add(ControlControlPlanTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildControlControlPlanQuery::create();
        $criteria->add(ControlControlPlanTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ControlControlPlan (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ControlControlPlan Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addControlControlPlans($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addControlControlPlans($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addControlControlPlans($this);
             */
        }
    ...
    public function getUsers(ConnectionInterface $con = null)
    {
        if ($this->aUsers === null && ($this->who_measures != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsers->addControlControlPlans($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeControlControlPlan($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeControlControlPlan($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeControlControlPlan($this);
        }
        if (null !== $this->aUsers) {
            $this->aUsers->removeControlControlPlan($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ControlControlPlanTableMap::DEFAULT_STRING_FORMAT);
    }
