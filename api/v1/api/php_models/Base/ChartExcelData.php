...
/**
 * Base class that represents a row from the 'chart_excel_data' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ChartExcelData implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ChartExcelDataTableMap';
    ...
    /**
     * Initializes internal state of Base\ChartExcelData object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ChartExcelData</code> instance.  If
     * <code>obj</code> is an instance of <code>ChartExcelData</code>, delegates to
     * <code>equals(ChartExcelData)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ChartExcelData The current object, for fluid interface
     */
     ...
     * @return $this|\ChartExcelData The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChartExcelDataTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ChartExcelDataTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setPhaseId($v)
    {
        ...
        if ($this->phase_id !== $v) {
            $this->phase_id = $v;
            $this->modifiedColumns[ChartExcelDataTableMap::COL_PHASE_ID] = true;
        }
    ...
    public function setPhaseComponentId($v)
    {
        ...
        if ($this->phase_component_id !== $v) {
            ...
            $this->modifiedColumns[ChartExcelDataTableMap::COL_PHASE_COMPONENT_ID] = true;
        }
    ...
    public function setDataUrl($v)
    {
        ...
        if ($this->data_url !== $v) {
            $this->data_url = $v;
            $this->modifiedColumns[ChartExcelDataTableMap::COL_DATA_URL] = true;
        }
    ...
    public function setDateTimeCreated($v)
    {
        ...
        if ($this->date_time_created !== null || $dt !== null) {
            if ($this->date_time_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_time_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChartExcelDataTableMap::COL_DATE_TIME_CREATED] = true;
            }
    ...
    public function setLastUpdated($v)
    {
        ...
        if ($this->last_updated !== null || $dt !== null) {
            if ($this->last_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChartExcelDataTableMap::COL_LAST_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChartExcelDataTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChartExcelDataTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ChartExcelDataTableMap::translateFieldName('PhaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ChartExcelDataTableMap::translateFieldName('PhaseComponentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phase_component_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ChartExcelDataTableMap::translateFieldName('DataUrl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->data_url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ChartExcelDataTableMap::translateFieldName('DateTimeCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_time_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ChartExcelDataTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = ChartExcelDataTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ChartExcelData'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChartExcelDataQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ChartExcelData::setDeleted()
     * @see ChartExcelData::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChartExcelDataQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChartExcelDataTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ChartExcelDataTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ChartExcelDataTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_id`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PHASE_COMPONENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`phase_component_id`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_DATA_URL)) {
            $modifiedColumns[':p' . $index++]  = '`data_url`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_DATE_TIME_CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`date_time_created`';
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_LAST_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`last_updated`';
        }

        $sql = sprintf(
            'INSERT INTO `chart_excel_data` (%s) VALUES (%s)',
    ...
    {
        $pos = ChartExcelDataTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ChartExcelData'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ChartExcelData'][$this->hashCode()] = true;
        $keys = ChartExcelDataTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProjectId(),
            $keys[2] => $this->getPhaseId(),
            $keys[3] => $this->getPhaseComponentId(),
            $keys[4] => $this->getDataUrl(),
    ...
    {
        $criteria = new Criteria(ChartExcelDataTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ChartExcelDataTableMap::COL_ID)) {
            $criteria->add(ChartExcelDataTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PROJECT_ID)) {
            $criteria->add(ChartExcelDataTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PHASE_ID)) {
            $criteria->add(ChartExcelDataTableMap::COL_PHASE_ID, $this->phase_id);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_PHASE_COMPONENT_ID)) {
            $criteria->add(ChartExcelDataTableMap::COL_PHASE_COMPONENT_ID, $this->phase_component_id);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_DATA_URL)) {
            $criteria->add(ChartExcelDataTableMap::COL_DATA_URL, $this->data_url);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_DATE_TIME_CREATED)) {
            $criteria->add(ChartExcelDataTableMap::COL_DATE_TIME_CREATED, $this->date_time_created);
        }
        if ($this->isColumnModified(ChartExcelDataTableMap::COL_LAST_UPDATED)) {
            $criteria->add(ChartExcelDataTableMap::COL_LAST_UPDATED, $this->last_updated);
        }
    ...
    {
        $criteria = ChildChartExcelDataQuery::create();
        $criteria->add(ChartExcelDataTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChartExcelData (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChartExcelData Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProjects(ConnectionInterface $con = null)
    {
        if ($this->aProjects === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProjects->addChartExcelDatas($this);
             */
        }
    ...
    public function getProjectPhases(ConnectionInterface $con = null)
    {
        if ($this->aProjectPhases === null && ($this->phase_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProjectPhases->addChartExcelDatas($this);
             */
        }
    ...
    public function getPhaseComponents(ConnectionInterface $con = null)
    {
        if ($this->aPhaseComponents === null && ($this->phase_component_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPhaseComponents->addChartExcelDatas($this);
             */
        }
    ...
    {
        if (null !== $this->aProjects) {
            $this->aProjects->removeChartExcelData($this);
        }
        if (null !== $this->aProjectPhases) {
            $this->aProjectPhases->removeChartExcelData($this);
        }
        if (null !== $this->aPhaseComponents) {
            $this->aPhaseComponents->removeChartExcelData($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ChartExcelDataTableMap::DEFAULT_STRING_FORMAT);
    }
