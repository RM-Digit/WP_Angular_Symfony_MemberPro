<?php
	class l6edefineraci extends APIApp{
		protected $response;
		...
		private function handlePost($args){
			switch ($this->post_action){
				...
				case 'update':
					$vals = $args['vals'];
					$filters = $this->formatFilters('DefineRaci', $args['filters']);
					$q = DefineRaciQuery::create();
					if ($filters){
