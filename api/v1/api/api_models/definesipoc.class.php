<?php
	class l6edefinesipoc extends APIApp{
		protected $response;
		...
		private function handlePost($args){
			switch ($this->post_action){
				...
				case 'update':
					$vals = $args['vals'];
					$filters = $this->formatFilters('DefineSipoc', $args['filters']);
					$q = DefineSipocQuery::create();
					if ($filters){
