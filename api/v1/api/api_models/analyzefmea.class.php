<?php
	class l6eanalyzefmea extends APIApp{
		protected $response;
		...
		private function handlePost($args){
			switch ($this->post_action){
				...
				case 'update':
					$vals = $args['vals'];
					$filters = $this->formatFilters('AnalyzeFmea', $args['filters']);
					$q = AnalyzeFmeaQuery::create();
					if ($filters){
