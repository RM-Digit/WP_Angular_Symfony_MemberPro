<?php
	class l6egatereview extends APIApp{
		protected $response;
		...
		private function handlePost($args){
			switch ($this->post_action){
				...
				case 'update':
					$vals = $args['vals'];
					$filters = $this->formatFilters('GateReview', $args['filters']);
					$q = GateReviewQuery::create();
					if ($filters){
